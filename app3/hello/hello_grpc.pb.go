...
type HelloServiceClient interface {
	SayHello(ctx context.Context, in *Who, opts ...grpc.CallOption) (*Hello, error)
}
...
func (c *helloServiceClient) SayHello(ctx context.Context, in *Who, opts ...grpc.CallOption) (*Hello, error) {
...
type HelloServiceServer interface {
	SayHello(context.Context, *Who) (*Hello, error)
...
func (UnimplementedHelloServiceServer) SayHello(context.Context, *Who) (*Hello, error) {
...
func _HelloService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloServiceServer).SayHello(ctx, req.(*Who))
	}
